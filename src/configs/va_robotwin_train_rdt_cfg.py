...
# va_robotwin_train_rdt_cfg.multi_view_image_mode = 'vertical'
# va_robotwin_train_rdt_cfg.multi_view_image_mode = 'frame'
# va_robotwin_train_rdt_cfg.multi_view_image_mode = 'first'
